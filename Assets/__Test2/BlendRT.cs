...
public class BlendRT : ScriptableRendererFeature
{
	...
	class BlendRTPass : ScriptableRenderPass
	{
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //Blend Depth first
            cmd.Blit( renderingData.cameraData.renderer.cameraColorTarget , RTCollection.Blended_Depth.tex , RTCollection.mat_Blend_Depth );
            ...
            cmd.Blit( RTCollection.Blended_Depth.tex , renderingData.cameraData.renderer.cameraDepthTarget , RTCollection.mat_Blend_Depth );
            context.ExecuteCommandBuffer(cmd);
            cmd.Clear();

            cmd.Blit( renderingData.cameraData.renderer.cameraColorTarget , RTCollection.Blended_ShadowMain.tex , RTCollection.mat_Blend_ShadowMain );
            cmd.SetGlobalTexture("_MainLightShadowmapTexture", RTCollection.Blended_ShadowMain.tex );

            cmd.Blit( renderingData.cameraData.renderer.cameraColorTarget , RTCollection.Blended_ShadowAdd.tex , RTCollection.mat_Blend_ShadowAdd );
            cmd.SetGlobalTexture("_AdditionalLightsShadowmapTexture", RTCollection.Blended_ShadowAdd.tex );

            //Blend Colors
            cmd.Blit( renderingData.cameraData.renderer.cameraDepthTarget , RTCollection.Blended_GBuffer0.tex , RTCollection.mat_Blend_GBuffer0 );
            cmd.SetGlobalTexture( "_GBuffer0", RTCollection.Blended_GBuffer0.tex );
            
            cmd.Blit( renderingData.cameraData.renderer.cameraDepthTarget , RTCollection.Blended_GBuffer1.tex , RTCollection.mat_Blend_GBuffer1 );
            cmd.SetGlobalTexture( "_GBuffer1", RTCollection.Blended_GBuffer1.tex );

            cmd.Blit( renderingData.cameraData.renderer.cameraDepthTarget , RTCollection.Blended_GBuffer2.tex , RTCollection.mat_Blend_GBuffer2 );
