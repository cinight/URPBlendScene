Shader "Custom/CollectRT_ShadowAdd"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #if MSAA_SAMPLES == 1
                DEPTH_TEXTURE(_AdditionalLightsShadowmapTexture);
                SAMPLER(sampler_AdditionalLightsShadowmapTexture);
            #else
                DEPTH_TEXTURE_MS(_AdditionalLightsShadowmapTexture, MSAA_SAMPLES);
            ...
            fout frag_Test(Varyings input)
            {
                ...
                float col = SAMPLE_DEPTH_TEXTURE(_AdditionalLightsShadowmapTexture, sampler_AdditionalLightsShadowmapTexture, input.texcoord);
